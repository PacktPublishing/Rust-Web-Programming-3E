(module
  ...
  (func (;11;) (type 7) (param i32 i32 i32 i32)
    ...
    i32.const 1
    i32.store)
  (func (;12;) (type 8) (param i32 i32 i32 i32 i32 i32)
    (local i32 i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;29;) (type 0) (param i32 i32)
    local.get 0
    i64.const 7916663017593141705
    i64.store offset=8
    local.get 0
    i64.const 8259774374431045597
    i64.store)
  (func (;30;) (type 0) (param i32 i32)
    local.get 0
    i64.const 8539995352090740368
    i64.store offset=8
    local.get 0
    i64.const -5441813922324612405
    i64.store)
